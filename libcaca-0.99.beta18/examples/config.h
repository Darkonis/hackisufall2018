...
/* #undef ALLOCCONSOLE_IN_WINDOWS_H */
...
/* Define to 1 if you have the ‘fldln2’ and other floating point
   instructions. */
#define HAVE_FLDLN2 1

/* Define to 1 if you have the ‘fsin’ and ‘fcos’ instructions. */
#define HAVE_FSIN_FCOS 1
...
/* Define to 1 if you have the ‘SLsmg_utf8_enable’ function. */
#define HAVE_SLSMG_UTF8_ENABLE 1
...
/* Define to 1 to activate profiling */
/* #undef PROF */
...
/* Define to 1 to activate the Cocoa backend driver */
/* #undef USE_COCOA */

/* Define to 1 to activate the conio.h backend driver */
/* #undef USE_CONIO */

/* Define to 1 to activate the OpenGL backend driver */
/* #undef USE_GL */

/* Define to 1 to use Imlib2 */
/* #undef USE_IMLIB2 */

/* Define to 1 to activate kernel mode */
/* #undef USE_KERNEL */

/* Define to 1 to activate the ncurses backend driver */
#define USE_NCURSES 1

/* Define to 1 to activate plugins */
/* #undef USE_PLUGINS */

/* Define to 1 to activate the slang backend driver */
#define USE_SLANG 1

/* Define to 1 to activate the VGA backend driver */
/* #undef USE_VGA */

/* Define to 1 to activate the win32 backend driver */
/* #undef USE_WIN32 */

/* Define to 1 to activate the X11 backend driver */
#define USE_X11 1
